...
function openLegal(tipo) {
    ...
    if (tipo === 'privacidad') {
        ...
        body.innerHTML = `<p>Al reservar con nosotros aceptas las normas de convivencia y políticas de cancelación de Casa El Cedro. El respeto por el entorno natural y la tranquilidad de los demás huéspedes es fundamental.</p>`;
    }
...
// Eventos de cierre
if (btnOk) btnOk.onclick = () => modalLegal.style.display = "none";
if (btnClose) btnClose.onclick = () => modalLegal.style.display = "none";

window.onclick = (event) => { 
    if (event.target == modalLegal) modalLegal.style.display = "none"; 
};
